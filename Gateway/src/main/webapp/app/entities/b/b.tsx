...
export const B = () => {
  ...
  const bList = useAppSelector(state => state.gateway.b.entities);
  ...
  return (
    <div>
      <h2 id="b-heading" data-cy="BHeading">
        <Translate contentKey="gatewayApp.b.home.title">BS</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="gatewayApp.b.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/b/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="gatewayApp.b.home.createLabel">Create new B</Translate>
          </Link>
        </div>
      </h2>
        ...
        {bList && bList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="gatewayApp.b.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="gatewayApp.b.a">A</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="gatewayApp.b.home.notFound">No BS found</Translate>
            </div>
          )
        )}
      </div>
