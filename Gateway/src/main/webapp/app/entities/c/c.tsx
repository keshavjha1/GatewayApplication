...
export const C = () => {
  ...
  const cList = useAppSelector(state => state.gateway.c.entities);
  const loading = useAppSelector(state => state.gateway.c.loading);
  ...
  return (
    <div>
      <h2 id="c-heading" data-cy="CHeading">
        <Translate contentKey="gatewayApp.c.home.title">CS</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="gatewayApp.c.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/c/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="gatewayApp.c.home.createLabel">Create new C</Translate>
          </Link>
        </div>
      </h2>
        ...
        {cList && cList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="gatewayApp.c.id">ID</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="gatewayApp.c.home.notFound">No CS found</Translate>
            </div>
          )
        )}
      </div>
