...
export const A = () => {
  ...
  const aList = useAppSelector(state => state.gateway.a.entities);
  const loading = useAppSelector(state => state.gateway.a.loading);
  ...
  return (
    <div>
      <h2 id="a-heading" data-cy="AHeading">
        <Translate contentKey="gatewayApp.a.home.title">AS</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="gatewayApp.a.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/a/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="gatewayApp.a.home.createLabel">Create new A</Translate>
          </Link>
        </div>
      </h2>
        ...
        {aList && aList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="gatewayApp.a.id">ID</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="gatewayApp.a.home.notFound">No AS found</Translate>
            </div>
          )
        )}
      </div>
