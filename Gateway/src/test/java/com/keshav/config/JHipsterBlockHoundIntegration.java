...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.keshav.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.keshav.security.DomainUserDetailsService", "createSpringSecurityUser");
